...
<head>
    ...
    <!--title-->
    <title>TLI conpensation plan</title>
...
<div class="main">
    ...
    <!--hero section start-->
    <section class="hero-section pt-100" style="background-color: #5B2C6F">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-6">
                    <div class="hero-content-left position-relative mt-lg-0 mt-md-3 mt-5 text-white">
                        <h1 class="" style="color: #B7950B">Build Anything That You Want With TLI Compensation Plan</h1>
                        ...
                        <a href="register" class="btn solid-btn text-white" style="background-color: #B7950B"> Get Started Now</a>
         
                    </div>
                </div>
                <div class="col-md-5 col-lg-5" style="position: relative; z-index: 1">
                    <div class=" mt-5">
    ...
    <section class="promo-section ptb-100">
        <div class="container">
            <!--clients logo start-->
            <!-- <div class="row justify-content-between pb-100">
                <div class="col-md-12">
                    <div class="client-section-wrap d-flex flex-row align-items-center">
                        ...
                        <ul class="list-inline justify-content-between">
                            ...
                            <li class="list-inline-item"><img src="img/client-3-color.png" width="85" alt="client"
                                                              class="img-fluid"></li>
                            <li class="list-inline-item"><img src="img/client-4-color.png" width="85" alt="client"
                                                              class="img-fluid"></li>
                            <li class="list-inline-item"><img src="img/client-5-color.png" width="85" alt="client"
                                                              class="img-fluid"></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-9">
                    <div class="section-heading text-center mb-5">
                        <h2>Why you should join TLI?</h2>
                        <p class="lead">
                            Following reasons show advantages of adding AgencyCo to your lead pages, demos and checkouts team building e-tailers after timely schemas.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row no-gutters">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-services single-feature-hover gray-light-bg single-feature text-center p-5 h-100">
                        <span class="ti-bar-chart text-white icon rounded" style="background-color: #5B2C6F"></span>
                        <div class="feature-content">
                            <h5 class="mb-2">Convert traffic into sales</h5>
                            <p>where we use search engines to market your product through paid methods pay per click services.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-services single-feature-hover gray-light-bg single-feature text-center p-5 h-100">
                        <span class="ti-shield text-white icon rounded" style="background-color: #5B2C6F"></span>
                        <div class="feature-content">
                            <h5 class="mb-2">Instant withdrawal</h5>
                            <p>While browsing Facebook or Twitter or even Linkedin, you are subjected to advertisements.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-services single-feature-hover gray-light-bg single-feature text-center p-5 h-100">
                        <span class="ti-cup text-white icon rounded" style="background-color: #5B2C6F"></span>
                        <div class="feature-content">
                            <h5 class="mb-2">Growth guaranteed</h5>
                            <p>Marketing is one of the most popular strategies offered full-service marketing agencies.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="call-to-action ptb-100" style="background-color: #5B2C6F">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="call-to-action-content text-center text-white mb-5">
                        <h2 class="text-white">TLI compensation plan is trusted.</h2>
                        <p class="lead">Authoritatively empower best-of-breed solutions for best-of-breed applications. Continually whiteboard sustainable e-services for sustainable synergy. </p>
                    </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        <div class="pt-5">
                            <h5 class="mb-0">Basic License</h5>
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn primary-outline-btn mb-3" target="_blank">Purchase now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card popular-price text-center single-pricing-pack">
                        <div class="pt-5">
                            <h5 class="mb-0">Standard License <span class="badge badge-danger">Popular</span></h5>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        <div class="pt-5">
                            <h5 class="mb-0">Extended License
                            </h5>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading mb-5 text-center">
                        <h2>Testimonials What Members Say</h2>
                        <p class="lead">
...
<?php include('include/main_foot.php') ?>
