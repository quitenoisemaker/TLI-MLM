...
$sql = "delete from tutorial_videos where id =$id";
$result = $con->query($sql);
 
echo "<script>alert('Video deleted successfully')</script>";
 echo "<script>window.open('videos','_self')</script>";
...
<body>
                  ...
                  <!-- ends -->
                    ...
                    <div class="card">
                        ...
                        <div class="">
                            ...
                            <label>Title</label>
                            <input required type="text" class="form-control" name="title" placeholder="Enter video title">
                          </div>
                          <div class="col-lg-12 form-group">
                            <label>Video link</label>
                            <input required type="text" class="form-control" name="link" placeholder="Enter video link">
                          </div>
                       <div class="row p-2">
                                  ...
                                  if ($result->num_rows >0) {
                                    ...
                                    while ( $row = $result->fetch_assoc())  {
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <a href="videos_update?id=<?php echo $row['id'];?>">
                                            <span class="badge badge-success">Update</span></a>
                                        </td>
                                        <td>
                                            <a href="videos?del=<?php echo $row['id'];?>" onclick="return confirm('Do you want to delete');">
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_videos= mysqli_query($con, "INSERT INTO `tutorial_videos`(`id`, `youtube_link`, `description`, `stage_id`) VALUES (NULL,'$link','$title','$stage')");
        if ($insert_videos) {
            echo "<script>alert('Video has been added')</script>";
            echo "<script>window.open('videos','_self')</script>";
             }else{
                echo "<script>alert('Opps! Error adding video')</script>";
             }
    }
    ?>
</body>
