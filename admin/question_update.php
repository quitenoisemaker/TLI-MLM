...
<body>
                                ...
                                <div class="p-5">
                                    <form action="" method="POST">
                                        ...
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="question"><?php
                                            if(isset($_SESSION['email'])) {

                                                $id=$_GET['id'];
                                                $sql = " SELECT * FROM training_questions where id='".$id."'";
                                                    $result = $con->query($sql);
                                                if($result->num_rows>0){
                                                  while($row=$result->fetch_assoc()){
                                                    $question=$row["question"]; echo htmlspecialchars("$question") ; } } } ?>
                                            </textarea>
                                        </div>
    ...
    if (isset($_POST['submit'])) {
      ...
      $id=$_GET['id'];
        ...
        $sql = "UPDATE training_questions SET stage_id= '$stage', question='$question' WHERE id=$id";
        
        if(mysqli_query($con, $sql)) {

            echo "<script>alert('Question has been edited')</script>";
