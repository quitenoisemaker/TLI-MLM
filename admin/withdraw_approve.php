                        ...
                        <div class="table-responsive mb-0" data-list="{&quot;valueNames&quot;: [&quot;goal-project&quot;, &quot;goal-status&quot;, &quot;goal-progress&quot;, &quot;goal-date&quot;]}">
                            <table id="table_id" class="table table-sm table-nowrap card-table">
                                ...
                                <tbody class="list">
                                    <?php
                              $status= 1;
                                $sql1 = "SELECT * from  fund_withdrawal where status = $status ORDER by apply_date desc";
                                ...
                                { ?>
                                  <!-- To get user details -->
                                    <?php
                                      $customers=mysqli_query($con, "SELECT * FROM `customers` WHERE id = '$row1[user_id]' ");
                                    ...
                                    <?php
                                      $administrator=mysqli_query($con, "SELECT * FROM `administrator` WHERE admin_id = '$row1[approved_by]' ");
                                        
                                        $row_administrator=mysqli_fetch_array($administrator);
                                     ?>
                                     <!-- End -->
                                    <tr>
                                        <td class="goal-project">
                                            <?php echo $row_customers['fname'] . " ". $row_customers['lname'];?>
                                        </td>
                                        <td class="goal-status">
                                            <?php echo $row_customers['email'];?>
                                        </td>
                                        <td class="goal-progress">
                                            <?php echo htmlentities($row1['amount']);?>
                                        </td>
                                        <td class="goal-date">
                                            <time datetime="2018-10-24">
                                                <?php echo htmlentities($row1['type']);?></time>
                                        </td>
                                        <td class="goal-date">
                                            <time datetime="2018-10-24">
                                                <?php echo $row_administrator['fname'] ." ". $row_administrator['lname'];?></time>
                                        </td>
                                        <td class="goal-date">
                                            <time datetime="2018-10-24">
                                                <?php echo htmlentities($row1['apply_date']);?></time>
                                        </td>
                                        <td>
                                            <a href="single_members?id=<?php echo $row1['user_id'];?>"><span class="badge badge-info btn-sm"><i class="fas fa-eye"></i></span></a>
                                        </td>
...
$sql = "UPDATE customers SET status=$status WHERE  id=$eid";
$query =$con->query($sql);
