...
<body>
                            ...
                            <div class="card ">
                                ...
                                <form action="" method="POST">
                                    <div class="col-lg-12 form-group">
                                        <label>Title</label>
                                        <input required type="text" class="form-control" placeholder="Enter title" name="title" value="<?php
                    if(isset($_SESSION['email'])) {

                        $id=$_GET['id'];
                      

                        $sql = "SELECT * FROM tutorial_videos where id ='".$id."'";
                        ...
                        ?>" required>
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <input required type="text" class="form-control" placeholder="Enter video link" name="link" value="<?php
                    if(isset($_SESSION['email'])) {
    ...
    if (isset($_POST['submit'])) {
      ...
      $id=$_GET['id'];
        ...
        $sql = "UPDATE tutorial_videos SET youtube_link= '$link', description='$title', stage_id='$stage' WHERE id=$id";
