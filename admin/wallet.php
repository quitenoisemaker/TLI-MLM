...
<body>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            ...
                                            <!-- Heading -->
                                            <span class="h2 mb-0">NGN<span class="fund-balance"><?php
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <!-- Form -->
                                    <form id="get-amount" method="POST">
                                        <!-- Amount -->
                                        <div class="form-group">
                                            ...
                                            <!-- Input -->
                                            <input required type="number" class="form-control" name="amount" placeholder="Enter amount to be funded">
                                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-nowrap card-table">
                                ...
                                <?php
                                 ...
                                 if (isset($_SESSION['user_email'])) {
                                    $get_email=mysqli_query($con, "SELECT * FROM `ewallet_payment` WHERE email='$_SESSION[user_email]' ");
    ...
    <script>
    $(document).on('submit', '#get-amount', function(e) {
        e.preventDefault();
        let mee = $(this);
        
        let pay_amount = mee.find('[name=amount]').val();
        ...
        var handler = PaystackPop.setup({
            ...
            callback: function(response) {
                ...
                $.ajax({
                    url: './config/data?action=fund_wallet',
                    type: 'POST',
                    data: { pay_money: pay_amount, ref: response.reference },
                    cache: false,
                      ...
                      // alert(data)
                        if (data == true) {
                            Swal.fire({
                                type: 'success',
                                title: "Wallet Funded !",
                                text: "Your wallet has been funded with NGN" + Number(pay_amount).toLocaleString(),
                                AllowEscapeKey: false,
