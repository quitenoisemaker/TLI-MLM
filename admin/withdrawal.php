    ...
    <div class="main-content">
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          ...
          <!-- Card -->
            <div class="card">
              <div class="card-header alert alert-primary col-auto">
              ...
              <div class="card-body">
                ...
                <form action="" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <label class="radio-inline p-2"><input type="radio" name="optradio" checked>Network</label>

                    <label class="radio-inline p-2 float-right"><input type="radio" name="optradio">Funded wallet</label>
                  ...
                  <!-- Submit -->
                  <button class="btn btn-primary lift" type="submit" name="submit">
                    Withdraw
                  </button>
