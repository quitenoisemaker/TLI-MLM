...
<!-- Copied from https://dashkit.goodthemes.co/account-members.html by Cyotek WebCopy 1.8.0.652, Wednesday, 17 June 2020, 1:15:23 pm -->
  ...
  <body>
          ...
          <div class="col-12 col-lg-10 col-xl-12">
            ...
            <!-- header3 -->
                  ...
                  <!-- ends -->
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive mb-0" data-list="{&quot;valueNames&quot;: [&quot;goal-project&quot;, &quot;goal-status&quot;, &quot;goal-progress&quot;, &quot;goal-date&quot;]}">
                            <table id="table_id" class="table table-sm table-nowrap card-table">
                                <thead>
                                    <tr>
                                        <th>
                                            <a href="#" class="text-dark list-sort" data-sort="goal-project">
                                                #
                                            </a>
                                        </th>
                                        <th>
                                            <a href="#" class="text-dark list-sort" data-sort="goal-status">
                                                First name
                                            </a>
                                        </th>
                                        <th>
                                            <a href="#" class="text-dark list-sort" data-sort="goal-progress">
                                                Last name
                                            </a>
                                        </th>
                                        <th>
                                            <a href="#" class="text-dark list-sort" data-sort="goal-date">
                                                Email
                                            </a>
                                        </th>
                                        <th>
                  ...
                  $status= 0;
                    ...
                    { ?>  
                    <tr>
                      <td class="goal-project"><?php echo htmlentities($cnt);?></td>
                      <td class="goal-status"><?php echo htmlentities($row['fname']);?></td>
                      <td class="goal-progress"><?php echo htmlentities($row['lname']);?></td>
                      <td class="goal-date"><?php echo htmlentities($row['email']);?></td>
                      <td class="goal-date"><?php echo htmlentities($row['username']);?></td>
                      <td class="goal-date"><?php echo htmlentities($row['user_link']);?></td>
                      <td class="goal-progress"><?php echo htmlentities($row['date_created']);?></td>
                      <td class="goal-progress">
                        <a href="single_members?id=<?php echo $row['id'];?>"><span class="badge badge-info btn-sm"><i class="fas fa-eye"></i></span></a>
                      </td>
                      <td class="goal-progress"><?php if($row['status']=="" || $row['status']==0){ ?>
                        <a class="badge badge-warning btn-sm" href="pending?aeid=<?php echo htmlentities($row['id']);?>" onclick="return confirm('Do you really want to Activate user?')">Activate</a>
                        <?php }else {?>

                        <a class="btn btn-success btn-sm" href="manage-users.php?eid=<?php echo htmlentities($row['id']);?>" onclick="return confirm('Do you want to activate user?')">User Suspended</a>
    ...
    <?php
        ...
        $sql = "UPDATE customers SET status=$status WHERE  id=$aeid";
        $query =$con->query($sql);
        
        echo "<script>alert('User Successfully Activated')</script>";

          echo "<script>window.open('pending','_self')</script>";
        }
