                        ...
                        <div class="table-responsive mb-0" data-list="{&quot;valueNames&quot;: [&quot;goal-project&quot;, &quot;goal-status&quot;, &quot;goal-progress&quot;, &quot;goal-date&quot;]}">
                            <table id="table_id" class="table table-sm table-nowrap card-table">
                                ...
                                <tbody class="list">
                                    <?php
                                    $status= 0;
                                      $sql1 = "SELECT * from  support_ticket where status = $status";
                                    ...
                                    <tr>
                                        ...
                                        <td class="goal-progress">
                                            <?php echo htmlentities($row1['subject']);?>
                                        </td>
                                        <td class="goal-date">
                                            <time datetime="2018-10-24">
                                                
                                                  <?php echo substr($row1['text'], 0, 20). '...'  ?>
                                                </time>
                                        </td>
                                        <td class="goal-date">
                                            <time datetime="2018-10-24">
                                                <?php echo htmlentities($row1['date_created']);?></time>
                                        </td>
                                        <td>
                                            <a href="single_ticket?id=<?php echo $row1['unique_id'];?>"><span class="badge badge-info btn-sm">view</span></a>
                                        </td>
                                        <!-- <td>
