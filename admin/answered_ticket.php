                        ...
                        <div class="table-responsive mb-0" data-list="{&quot;valueNames&quot;: [&quot;goal-project&quot;, &quot;goal-status&quot;, &quot;goal-progress&quot;, &quot;goal-date&quot;]}">
                            <table id="table_id" class="table table-sm table-nowrap card-table">
                                ...
                                <tbody class="list">
                                    <?php
                              $status= 1;
                                $sql1 = "SELECT * from  support_ticket where status = $status ORDER by date_created desc";
                                ...
                                { ?>
                                  <!-- To get user details -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="single_answered_ticket?id=<?php echo $row1['user_id'];?>"><span class="badge badge-info btn-sm"><i class="fas fa-eye"></i></span></a>
                                        </td>
