      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="card">
              <div class="card-body">
                <h2 class="text-dark text-center mb-5">
                    Create new member.
                </h2>
                <form method="POST" action="">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-3">
                                <hr>
                        <label class="text-dark">Bank details</label>
                            <hr>
                        </div>
                        ...
                        <div class="col-lg-12 form-group">
                            <button class="btn btn-lg btn-block btn-primary mb-3" name="submit">
        ...
        if(check_mail($_POST['email'])==true){
            ...
            if($count_refer < 1){
                ...
                if($count_matrix > 1){
                    ...
                    mysqli_query($con, "INSERT INTO `customers`(`id`, `fname`, `lname`, `email`, `fone`,`fone_network`,`password`, `gender`, `username`,`bank`,`bank_act_no`,`bank_type`,`b_name`, `vkey`, `status`, `date_created`, `user_link`, `last_login`) VALUES (NULL, '$fname','$lname','$_POST[email]','$_POST[fone]','$netw','$pass','$_POST[gender]','$_POST[username]','$_POST[bank]','$_POST[bank_act_no]','$_POST[bank_type]','$_POST[b_name]','$vkey','0','$date','$user_link','')");
                    ...
                    // $headers= 'From: Tli <contact@tli.com>';
              ...
              'content'=> array ( 0=> array ( 'type'=> 'text/html', 'value'=> "Thanks for registry with us. Please click on the link below to verify account. Thanks <br>
                <a href='https://tli/verify?vkey=$vkey'>Register account</a>"  ) ));
              $ch = curl_init();
              ...
              curl_close($ch);
                    ...
                    title: 'Sucessful',
                    title: 'Please check your mail to verify your account',
                    icon: 'success',
                    button: 'Ok!',
                  })</script>";
                }
