...
<!DOCTYPE html>
<html lang="en">
<!-- Copied from https://dashkit.goodthemes.co/index.html by Cyotek WebCopy 1.8.0.652, Wednesday, 17 June 2020, 1:15:23 pm -->
  <head>
    <meta charset="utf-8">
                ...
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <span class="h2 mb-0">
                      ...
                      $get_users=mysqli_query($con, "SELECT * FROM `customers`");
                ...
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <span class="h2 mb-0">
                      ...
                      <?php
                      $status=0;
                      $get_users=mysqli_query($con, "SELECT * FROM `customers` WHERE status= $status");
                      $count_users=mysqli_num_rows($get_users);
                  ...
                  <div class="col-auto">
                    ...
                    <!-- Icon -->
                    <span class="h2 fe fe-briefcase text-dark mb-0"></span>
                ...
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <span class="h2 mb-0">
                      ...
                      $get_ticket=mysqli_query($con, "SELECT * FROM `support_ticket` WHERE status='0'");
                      $count_ticket=mysqli_num_rows($get_ticket);
                ...
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <span class="h2 mb-0">
                      ...
                      <?php
                      $status=0;
                      $get_users=mysqli_query($con, "SELECT * FROM `fund_withdrawal` WHERE status= $status");
                      $count_users=mysqli_num_rows($get_users);
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-nowrap card-table">
                                ...
                                <?php
                                  $status=1;
                                 if (isset($_SESSION['email'])) {
                                    $sql = "SELECT * from  customers where status = $status ORDER by date_created desc LIMIT 10";
                                  ...
                                  if ($result->num_rows >0) {
                                    ...
                                    while ( $row = $result->fetch_assoc())  {
                                     ...
                                     <tr>
                                        <td>
                                           <a href="single_members?id=<?php echo $row['id'];?>"><span><i class="fas fa-eye"></i>
                                            <?php echo $row['fname']." ".$row['lname'] ?></span></a>
                                        </td>
                                        <td>
                                            <?php echo $row['fone'] ?>
                                        </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-nowrap card-table">
                                ...
                                <?php
                                  $status=0;
                                 if (isset($_SESSION['email'])) {
                                    $get_email=mysqli_query($con, "SELECT * FROM `customers` WHERE status='$status' ORDER by date_created desc LIMIT 10");
