...
if (isset($_POST['login'])) {
  ...
  $sql = "SELECT * FROM customers where email ='".$user_email."' and verify = '".$verify."' ";
  ...
  if($result->num_rows>0){
    while($row=$result->fetch_assoc()){
      ...
      if ($user_pass1 == $password) {
          ...
          header('location:user_dashboard/index');
  ...
  echo "<script>swal({
          title: 'Opps',
          text: 'Your account has not been verify, Please verify account',
          icon: 'warning',
          button: 'Ok!',
        })</script>";
      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-12 col-md-5 col-lg-6 col-xl-4 px-lg-6 my-5">
          ...
          <form action="" method="POST">
            ...
            <!-- Submit -->
            <button class="btn btn-lg btn-block text-white mb-3" name="login" style="background-color: #B7950B">
              Sign in
            </button>
        ...
        <div class="col-12 col-md-7 col-lg-6 col-xl-6 d-none d-lg-block ">
          ...
          <!-- Image -->
          <img src="assets/img/illustrations/scale.svg" width="600" alt="..." class="img-fluid">
