                        ...
                        <div class="header-body">
                                    ...
                                    <div class="col-12 col-lg-10 col-xl-12">
                                        ...
                                        <form class="tab-content py-6" id="wizardSteps" method="POST" action="">
                                            <div class="tab-pane fade show active" id="wizardStepOne" role="tabpanel" aria-labelledby="wizardTabOne">
                                                <!-- Header -->
                                                <div class="row justify-content-center">
                                                    <div class="col-12 col-md-10 col-lg-8 col-xl-10 text-center">
                                                        <!-- Pretitle -->
                                                        <h6 class="mb-2 text-uppercase text-dark">
                                                            Video 1 of 10
                                                        </h6>
                                                        <!-- Title -->
                                                        <h1 class="mb-1">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 1 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" name="submit" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepTwo">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepTwo" role="tabpanel" aria-labelledby="wizardTabTwo">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 2 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepThree">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepThree" role="tabpanel" aria-labelledby="wizardTabThree">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 3 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B"  data-toggle="wizard" href="#wizardStepFour">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepFour" role="tabpanel" aria-labelledby="wizardTabFour">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 4 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepFive">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepFive" role="tabpanel" aria-labelledby="wizardTabFive">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 5 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepSix">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepSix" role="tabpanel" aria-labelledby="wizardTabSix">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 6 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepSeven">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepSeven" role="tabpanel" aria-labelledby="wizardTabSeven">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 7 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepEight">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepEight" role="tabpanel" aria-labelledby="wizardTabEight">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 8 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepNine">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepNine" role="tabpanel" aria-labelledby="wizardTabNine">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 9 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepTen">Continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="wizardStepTen" role="tabpanel" aria-labelledby="wizardTabTen">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <!-- Step -->
                                                        <h6 class="text-uppercase text-dark mb-0">Video 10 of 10</h6>
                                                    </div>
                                                    <div class="col-auto">
                                                        <!-- Button -->
                                                        <a class="btn lift text-white" style="background-color: #B7950B" data-toggle="wizard" href="#wizardStepEleven">Write test</a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            $questions=mysqli_query($con, "SELECT * FROM `training_questions` WHERE stage_id='$stage' ");
                             ...
                             ?>
                                                                ...
                                                                <button class="btn text-white float-right" name="submit" style="background-color: #B7950B">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- Test question end -->
