...
<!doctype html>
<html lang="en">
<!-- Copied from https://dashkit.goodthemes.co/account-security.html by Cyotek WebCopy 1.8.0.652, Wednesday, 17 June 2020, 1:15:23 pm -->
  <head>
    <meta charset="utf-8">
          ...
          <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="row justify-content-between align-items-center mb-5">
              <div class="col-12 col-md-9 col-xl-7">
                ...
                <!-- Heading -->
                <h2 class="mb-2" style="color: #5B2C6F">
                  Change your password
                </h2>

                <!-- Text -->
                <p class="text-dark mb-xl-0">
                  We will email you a confirmation code when changing your password, so please expect that email after submitting.
                </p>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                ...
                <!-- Form -->
                <form class="password-save" method="POST">
                  ...
                  <!-- Submit -->
                  <button class="btn btn-block text-white lift" type="submit" name="submit" style="background-color: #B7950B">
                    Update password
                  </button>
...
if (isset($_POST['submit'])) {
  ...
  $password_again=md5($_POST['confirm_password']);
...
if ($old_password != $pass ) {
      ...
      elseif ($new_password != $password_again) {
        echo "<script>swal({
         ...
         $sql = "UPDATE customers SET password='$new_password' WHERE email='$user'";
