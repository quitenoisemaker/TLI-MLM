...
<body>
        ...
        <div class="container-fluid">
            ...
            $result = $con->query($sql);
                ...
                ?>
                    ...
                    <!-- Card -->
                    <div class="card">
                        <div class="card-header alert alert-light col-auto">
                            <b class="text-center">Fill form for withdrawal.</b>
                        </div>
                        <div class="card-body">
                            <!-- Form -->
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline p-2"><input type="radio" value="network" name="optradio" required>&nbsp&nbsp Network</label>
                                    <label class="radio-inline p-2 float-right"><input type="radio" value="wallet" name="optradio" required>&nbsp&nbsp Funded wallet</label>
                                </div>
                                <!-- New password -->
                                <div class="form-group">
                                    <!-- Label -->
                                ...
                                <!-- Submit -->
                                <button class="btn lift text-white" type="submit" name="submit" style="background-color: #B7950B">
                                    Withdraw
                                </button>
                            </form>
                        </div>
    ...
    $optradio=$_POST['optradio'];
        ...
        $refer=mysqli_query($con, "SELECT * FROM `customers` WHERE email='$user' ");
                    $row_refer=mysqli_fetch_array($refer);
        $us=mysqli_query($con, "SELECT * FROM `fund_withdrawal` WHERE user_id='$row_refer[id]' AND status='$status' ");
                        ...
                        if($count_users > 0){
                            ...
                            echo "<script>swal({
                                        ...
                                        title: 'Opps',
                                        text: 'You have a pending withdrawal',
                                        icon: 'warning',
                                        button: 'Ok!',
                                      })</script>";
                  ...
                  $result = $con->query($sql);
                   if($result->num_rows>0){
                       ...
                       if ($current_balance == 10000) {
                         echo "<script>swal({
                            title: 'Wallet is too low!',
                            text: 'You must have a minimum of NGR 10,000',
                            icon: 'warning',
                            button: 'Ok!',
                          })</script>";
                       }else{
      ...
      $row_user=mysqli_fetch_array($get_user);
        ...
        mysqli_query($con, "INSERT INTO `fund_withdrawal`(`fw_id`, `user_id`, `amount`,`type`, `status`, `approved_by`, `approved_date`, `apply_date`) VALUES (NULL,'$row_user[id]','$amount','$optradio','0','','','$date')");

         echo "<script>swal({
                  title: 'Withdrawal successful!',
                  text: 'Waiting for approval from administrator!',
                  icon: 'success',
                  button: 'Ok!',
                })</script>";
