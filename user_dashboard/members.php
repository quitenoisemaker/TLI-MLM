                  ...
                  <div class="list-group-item">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 ml-n2">
                        ...
                        <!-- Title -->
                        <h4 class="mb-1">
                          <a href="">Dianna Smiley</a>
                        </h4>

                        <!-- Email -->
                        <p class="small text-muted mb-0">
                          <a class="d-block text-reset text-truncate" href="">dianna.smiley@company.com</a>
                        </p>
                  ...
                  <div class="list-group-item">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 ml-n2">
                        ...
                        <!-- Title -->
                        <h4 class="mb-1">
                          <a href="">Daniela Dewitt</a>
                        </h4>

                        <!-- Email -->
                        <p class="small text-muted mb-0">
                          <a class="d-block text-reset text-truncate" href="">daniela.dewitt@company.com</a>
                        </p>
