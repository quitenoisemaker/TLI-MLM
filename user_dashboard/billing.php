...
<!doctype html>
<html lang="en">
<!-- Copied from https://dashkit.goodthemes.co/account-billing.html by Cyotek WebCopy 1.8.0.652, Wednesday, 17 June 2020, 1:15:23 pm -->
  <head>
    <meta charset="utf-8">
          ...
          <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="row justify-content-between align-items-center mb-5">
              <div class="col-12 col-md-9 col-xl-7">
                ...
                <p class="text-dark mb-xl-0">
                  We will email you a confirmation code when changing your details, so please expect that email after submitting.
                </p>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-12">
                ...
                <!-- Form -->
                <form class="billing-save" method="POST">
