                ...
                <div class="card" data-list='{"valueNames": ["item-name", "item-industry", "item-location", "item-owner", "item-created"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}' id="companiesList">
                    ...
                    <table class="table table-sm table-hover table-nowrap card-table">
                      <thead>
                        <tr>
                          ...
                          <th>
                            <a class="list-sort text-dark" data-sort="item-name" href="#">Subject</a>
                          </th>
                          <th>
                            <a class="list-sort text-dark" data-sort="item-industry" href="#">Status</a>
                          </th>
                          <th>
                            <a class="list-sort text-dark" data-sort="item-location" href="#">Date created</a>
                          </th>
                      ...
                      <tbody class="list font-size-base">
                              ...
                              <?php
                                 ...
                                 if (isset($_SESSION['user_email'])) {
                                    ...
                                    $get_ticket=mysqli_query($con, "SELECT * FROM `support_ticket` WHERE user_id='$row_refer[id]' ");
                            ...
                            <!-- Text -->
                            <span class="item-industry"><?php echo $row['subject']; ?></span>
                        ...
                        <a class="badge badge-warning btn-sm" href="single_ticket_user?id=<?php echo htmlentities($row['unique_id']);?>">Pending</a>
                        <?php }else {?>

                        <a class="btn btn-success btn-sm" href="single_ticket_user?id=<?php echo htmlentities($row['unique_id']);?>">Answered</a>
                        ...
                        <?php } ?>
                            ...
                            <!-- Text -->
                            <span class="item-location"><?php echo $row['date_created']; ?></span>
                                    ...
                                    <br><br>
                                    <h4 class='text-dark'> Opps! no ticket submitted</h4> <br>
                                    <div>";
                                  }
                  ...
                  <div class="card-footer d-flex justify-content-between">
                    ...
                    <ul class="list-pagination-prev pagination pagination-tabs card-pagination">
                      <li class="page-item">
                        <a class="page-link pl-0 pr-4 border-right text-dark" href="#">
                    ...
                    <ul class="list-pagination-next pagination pagination-tabs card-pagination">
                      <li class="page-item">
                        <a class="page-link pl-4 pr-0 border-left text-dark" href="#">
