...
<body>
    ...
    <div class="main-content">
        ...
        <div class="col-12 col-md-5 col-xl-6 my-5">
          
          <!-- Heading -->
         <div class="text-center">
                  <img src="assets/img/illustrations/happiness.svg" width="300" alt="..." class="img-fluid"><br>
                </div>
          
          <!-- Subheading -->
          <h2 class="display-3 text-center" style="color: #5B2C6F">Congratulations</h2>
          <h4 class="text-dark text-center mb-5 lead">
            You have passed the test. Click the link below to get certificate! Thanks 
          </h4>
          <div class="text-center">
          <a class="btn btn-lg text-white" href="certificate" style="background-color: #B7950B">Download certificate</a>
          </div>
