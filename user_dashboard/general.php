...
<!doctype html>
<html lang="en">
<!-- Copied from https://dashkit.goodthemes.co/account-general.html by Cyotek WebCopy 1.8.0.652, Wednesday, 17 June 2020, 1:15:23 pm -->
  <head>
    <meta charset="utf-8">
    ...
    if (isset($_POST['upload'])) {
      ...
      if (!empty($name)) {
        ...
        if (move_uploaded_file($tmp_name, $location.$name )){
          ...
          $sql = "UPDATE customers SET img='$name' WHERE email='$user'";
  ...
  ?>
    ...
    <div class="main-content">
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-lg-10 col-xl-8">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row justify-content-between align-items-center">
                  ...
                  <div class="row align-items-center">
                          ...
                          $user=$_SESSION['user_email'];
                            $sql = "SELECT * FROM customers where email ='".$user."'";
                              ...
                              if($result->num_rows>0){
                                while($row=$result->fetch_assoc()){
                                  $image=$row["img"];
                                  echo "<img class='avatar-img rounded-circle' src='img/$image' alt='' onclick='triggerClick()' id='image_display'>";
                                   }
                                }
                              }
                            ?>  
                    ...
                    <div class="col ml-n2">
                      ...
                      <small class="text-danger">
                        *file must be in jpg/jpeg and must be 2mb or less.
                      </small>
                ...
                <div class="col-auto">
                  ...
                  <!-- Button -->
                  <button class="btn btn-sm text-white" name="upload" style="background-color: #B7950B">
                    Upload
                  </button>
            ...
            <form action="" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <div class="form-group">
                    ...
                    <small class="form-text text-danger">
                      Email can't be edited. Thanks.
                    </small>

                    <!-- Input -->
                    <input type="email" class="form-control" disabled name="email" value="<?php
                    if(isset($_SESSION['user_email'])) {
                      $user=$_SESSION['user_email'];
                ...
                <div class="col-12 col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <!-- Input -->
                    <input type="text" class="form-control mb-3" placeholder="" name="phone" value="<?php
                    if(isset($_SESSION['user_email'])) {
                      $user=$_SESSION['user_email'];
              ...
              <!-- Button -->
              <button class="btn text-white" name="submit" style="background-color: #B7950B">
                Save changes
              </button>
     ...
     <?php
          ...
          $sql = "UPDATE customers SET fname='$fname', lname='$lname', fone='$phone' WHERE email='$user'";

          if(mysqli_query($con, $sql)) {
          echo "<script>swal({
          title: 'Good',
          text: 'Updated Successful, Thanks',
          icon: 'success',
          button: 'Ok!',
        })</script>";
          // echo "<script>window.open('user_account.php','_self')</script>";
          ...
          echo "<script>swal({
          title: 'Opps!',
          text: 'Problem in updating profile, try again',
          icon: 'error',
          button: 'Ok!',
        })</script>";
          }
